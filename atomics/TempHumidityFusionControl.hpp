...
{
  struct s1T : public in_port<int>{};
  struct s2T : public in_port<int>{};
  struct s3T : public in_port<int>{};
  struct s4T : public in_port<int>{};
  //struct s5T : public in_port<int>{};
  /*struct s6T : public in_port<int>{};
  struct s7T : public in_port<int>{};
  struct s8T : public in_port<int>{};
  struct s9T : public in_port<int>{};
  struct s10T: public in_port<int>{};*/
  struct s1H : public in_port<int>{};
  struct s2H : public in_port<int>{};
  struct s3H : public in_port<int>{};
  struct s4H : public in_port<int>{};
  //struct s5H : public in_port<int>{};
  /*struct s6H : public in_port<int>{};
  struct s7H : public in_port<int>{};
  struct s8H : public in_port<int>{};
  struct s9H : public in_port<int>{};
  struct s10H: public in_port<int>{};*/
  struct outT : public out_port<int> {};
  struct outH : public out_port<int> {};
};
...
*/
        ...
        /*  for(const auto &x : get_messages<typename defs::s5H>(mbs)) {
          ...
          state.FusedT = state.FusedT / 4;

          for(int i=0;i<4;i++) {
            state.FusedH = state.FusedH + state.sH[i];
          }

          state.FusedH = state.FusedH / 4;
